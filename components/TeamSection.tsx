...
const testimonialsByTeam: Record<TeamName, Testimonial[]> = {
  "2026 Team": [
    {
      id: 0,
      quote: "Licensee of TEDxSIST 2026, leading with vision and dedication to bring inspiring ideas to life.",
      name: "Thaarani S",
    ...
    {
      id: 1,
      quote: "Co-Organiser of TEDxSIST 2026, working alongside the team to ensure a successful and impactful event.",
      name: "Narean R",
    ...
    {
      id: 2,
      quote: "Cluster Coordinator, ensuring smooth communication and coordination across all teams.",
    ...
    {
      id: 4,
      quote: "Logistics and Management Lead, handling all logistical details to deliver a seamless event.",
      name: "Sai Tharang Padala",
      designation: "Logistics and Management Lead",
      src: "/logistics-and-management-lead.jpeg",
    },
    {
      id: 5,
      quote: "Design Lead, crafting visually stunning experiences that capture the essence of TEDxSIST.",
      name: "Adhikshithaa Vasanth",
      designation: "Design Lead",
      src: "/design-lead.jpeg",
    },
    {
      id: 6,
      quote: "Curation and Social Media Lead, curating powerful ideas and managing our social media presence.",
      name: "Gino Virgil Thiruchudar V",
      designation: "Curation and Social Media Lead",
      src: "/socialmedialead.jpg",
    },
  ],
  "Organisers": [
    {
